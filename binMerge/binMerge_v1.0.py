...
BIN_FILE_NAMES = []
BIN_FILE_NAMES.append("stm32h743vi-bootloader.bin") # bin文件名1
BIN_FILE_NAMES.append("gap.bin") # bin文件名2
BIN_FILE_NAMES.append("mxt2007.bin") # bin文件名3

ADDRESS = []
ADDRESS.append(0x08000000) # bin文件1地址
ADDRESS.append(0x08020000) # bin文件2地址
ADDRESS.append(0x08021000) # bin文件3地址
